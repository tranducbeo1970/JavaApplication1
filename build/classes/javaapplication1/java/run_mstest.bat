...
REM
java  -Djava.library.path="C:\PROGRA~1\Isode\bin" -classpath .;"c:\progra~1\Isode\bin\java\classes\isode-x400.jar;C:\Program Files\Isode\share\x400sdk\example\java" -verbose:jni -Xms20m X400_mstest
...
REM E:\j2sdk1.4.2_05\bin\javac -sourcepath . -verbose -classpath ".;c:\progra~1\Isode\bin\java\classes\isode-x400.jar;C:\Program Files\Isode\share\x400sdk\example\java" -g X400_mstest.java
