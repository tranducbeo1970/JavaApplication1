 ...
 *
 * Purpose:
 * Compare with CASE_005 and change ONLY the originator/mailbox.
 *
 * CASE_005:
 *   Originator = VVTSMHSA
 *
 ...
 *   VVTSYFYX
 *
 * All other controlled fields are intentionally kept unchanged.
 *
 * IMPORTANT:
 * MESSAGE_TEXT intentionally still contains "ORIGIN: VVTSMHSA".
 * This is deliberate so that the ASN.1 originator field can be
 * distinguished from text appearing inside the ATS body.
 */
public final class AmhsDatasetCase006OriginatorVVTSTEST {

    // ============================================================
    // P7 CONNECTION / ORIGINATOR
    // CONTROLLED CHANGE FROM CASE_005
    // ============================================================
    ...
    /*
     * Change this if the VVTSTEST mailbox uses a different password.
     */
    ...
    private static final String CASE_ID
            = "BASIC_GG_ORIGINATOR_VVTSTEST_006";
     ...
     * Keep identical to CASE_005.
     *
     * Do NOT replace VVTSMHSA with VVTSTEST here.
     * We want only the true X.400 originator to change.
     */
    ...
    private AmhsDatasetCase006OriginatorVVTSTEST() {
    }
    ...
    private static void buildBasicAtsMessage(X400Msg message)
        ...
        // ========================================================
        // ORIGINATOR
        // ONLY CONTROLLED CHANGE FROM CASE_005
        // ========================================================
        ...
        System.out.println(
                "Originator       : " + P7_USER_OR_ADDRESS
        );

        System.out.println(
                "Recipient[1]     : " + RECIPIENT_1_OR_ADDRESS
        );

        System.out.println(
                "Recipient[2]     : " + RECIPIENT_2_OR_ADDRESS
        );
    ...
    private static void printTestCase() {
        ...
        System.out.println(
                "AMHS DATASET CASE 006"
        );

        System.out.println(
                "BASIC GG - ORIGINATOR VVTSTEST"
        );
