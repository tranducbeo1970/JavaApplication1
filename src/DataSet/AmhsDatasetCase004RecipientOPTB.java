 ...
 *
 * Purpose:
 * Compare with CASE_003 and change ONLY the recipient.
 *
 * CASE_003:
 *   Recipient = VVTSOPTA
 *
 ...
 */
public final class AmhsDatasetCase004RecipientOPTB {
    ...
    private static final String CASE_ID
            = "BASIC_GG_RECIPIENT_OPTB_004";

    private static final String ATS_PRIORITY
            = "GG";

    /*
     * Keep exactly the same as CASE_003.
     */
    ...
    /*
     * IMPORTANT:
     * Keep the body identical to CASE_003.
     *
     * Although the real recipient is VVTSOPTB,
     * the text still says DESTINATION: VVTSOPTA on purpose.
     *
     * This allows us to isolate the ASN.1 recipient field.
     */
    ...
    private AmhsDatasetCase004RecipientOPTB() {
    }
    ...
    private static void buildBasicAtsMessage(X400Msg message)
        ...
        // ========================================================
        // RECIPIENT
        // ONLY CONTROLLED CHANGE IN CASE_004
        // ========================================================
        ...
        // ========================================================
        // ATS TEXT
        // Byte-for-byte semantic content kept from CASE_003
        // ========================================================
    ...
    private static void printTestCase() {
        ...
        System.out.println(
                "AMHS DATASET CASE 004"
        );

        System.out.println(
                "BASIC GG - RECIPIENT VVTSOPTB"
        );
