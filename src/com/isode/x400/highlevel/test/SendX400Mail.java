...
public class SendX400Mail {
	...
	private static String p3_channel_presentation_address = "\"593\"/Internet=192.168.22.186+102";
	private static String p3_user_or_address = "/CN=VVTSABCD/OU=VVTS/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
	private static String p3_user_password = "amhs";
	private static boolean submit_only = true;

	private static String recipient_or_address =  "/CN=VVDNYFYX/OU=VVDN/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
  ...
  final public static char CHAR_SOH = 1;
    ...
    //private static final String ICAO_EXTENDED_AMHS_POLICY_IDENTIFIER = "1.3.27.8.0.0";
    private static final String CR_LF = "\r\n";        
        
        
        private static String BuildIA5Content(String ct) {
        ...
        sb.append(CHAR_SOH).append(AMHS_PRI).append("GG").append(CR_LF + AMHS_FT).append(fillingtime).append(CR_LF);
	...
	public static void main(String[] args) {
		...
		try {
			...
			// If you don't want positive DRs, use DR_NON_DELIVERY_REPORT or DR_NO_REPORT
                        String aftn = "/CN=VVDNYFYX/OU=VVDN/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
                       //s x400msg.setFrom(aftn)
			x400msg.setTo(recipient_or_address, X400Msg.DR_Request.DR_NON_DELIVERY_REPORT, ipn_request);
                        //x400msg.setTo(aftn,X400Msg.DR_Request.DR_NON_DELIVERY_REPORT, X400Msg.IPN_NON_RECEIPT_NOTIFICATION);            
                ...
                /*s
                        ...
                        x400msg.setStringparam(X400_att.X400_S_ORIGINATORS_REFERENCE,"AAAAAAA");
...
//------------------------------------------------------------------                        
                        String temp = "CONG HOA XA HOI CHU NGHIA VIET NAM 1\r" + "CONG HOA XA HOI CHU NGHIA VIET NAM 2\r" + "CONG HOA XA HOI CHU NGHIA VIET NAM 3\r" + 
                         "CONG HOA XA HOI CHU NGHIA VIET NAM 4\r" + "CONG HOA XA HOI CHU NGHIA VIET NAM 5\r" + "CONG HOA XA HOI CHU NGHIA VIET NAM 6\r";
                        
                        String ct = BuildIA5Content(temp);
                        
                        
                        
			BodypartIA5Text ia5 = new BodypartIA5Text(ct);
