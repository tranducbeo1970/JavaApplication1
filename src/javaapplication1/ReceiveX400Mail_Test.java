 ...
 */
//import com.attech.amhs.common.MLogger;
//import com.attech.amhs.db.tables.Inbox;
 ...
 *
 */
public class ReceiveX400Mail_Test extends Thread {
    ...
    public ReceiveX400Mail_Test(String name) {
        super();
    ...
    public void run() {
        ...
        try {
            ...
            ArrayList<ListResult> list_array;
            String subject = "";
...
//                    listTheMailbox(connection);
                    ...
                    int result = X400ms.x400_ms_msggetstart(session, 180, message);
//                    final ReceivedMessage receivedMessage = new ReceivedMessage(result);
//                    Inbox inbox = receivedMessage.getInbox();
                    ...
                    if (result == X400_att.X400_E_INT_ERROR || result == X400_att.X400_E_SYSERROR) {
                        ...
                        connection.unbind();
                        throw new X400APIException(String.format("Getting message fail (seq: %s, code: %s %s)", "180", result, error));
                    }

                    // receivedMessage.setCode(result);
...
//                            d = new Date();
//                            date = CommonCode.convertDateToString(d, "yy MM dd HH mm ss");
//                            String[] strTime = date.split(" ");
//                            s = Integer.valueOf(strTime[4]);
//                            String m = "";
//                            if (s > 5) {
//                                s = s - 5;
//                            }
...
//                            } else {
//                                m = "0" + Integer.toString(s);
//
//                            }
////                            s = Integer.valueOf(strTime[5]);
//                            since = strTime[0] + strTime[1] + strTime[2] + strTime[3] + m + strTime[5] + "Z";
//                            System.out.println("Since: " + since);
                            //200108041516Z    
//                            list_array = connection.listMailbox("2001140310Z", entry_class, only_new_messages);
                            list_array = connection.listMailbox(date, entry_class, only_new_messages);
//                            System.out.println("Since: " + since);
...
//                            //try {Thread.sleep(10000);} catch (InterruptedException e) {}
                            ...
                            for (int i = 1; i < list_array.size(); i++) {
                                ...
                                rmsg = new ReceiveMsg(connection, lm.getSequenceNumber());
//				connection.deleteMessage(rm);
                                showMessage(rmsg);
                                System.out.println(rmsg.getTextContent());
                            }
                            break;
...
//                System.out.println("The getIPMHeaderRecipients is '" + rm.getIPMHeaderRecipients().toString() + "'");
//                System.out.println("The getMessageIdentifier is '" + rm.getMessageIdentifier().toString() + "'");
////                System.out.println("The getMessageType is '" + rm.getMessageType().toString() + "'");
//                Date d = rm.getMessageDeliveryTimeAsDate();
//                System.out.println("The getMessageDeliveryTimeAsDate is '" + rm.getMessageDeliveryTimeAsDate().toString() + "'");
////                System.out.println("The getMsgPrecedence is '" + rm.getMsgPrecedence() + "'");
                System.out.println("The getTextContent is '" + rm.getTextContent() + "'");
//                Date d = rm.getMessageSubmissionTimeAsDate();
//                date = CommonCode.convertDateToString(d, "yy MM dd HH mm ss");
//                String[] strTime = date.split(" ");
//                date = strTime[0] + strTime[1] + strTime[2] + strTime[3] + strTime[4] + strTime[5] + "Z";
                date = rm.getMessageDeliveryTime();
    ...
    public static void listTheMailbox(P7BindSession connection) throws X400APIException {
        ...
        for (int i = 1; i < list_array.size(); i++) {
            ...
            if (lm.getType() == X400Msg.X400_Message_Type.MESSAGE_TYPE_MESSAGE) {
                ...
                System.out.println("The Message getSequenceNumber is " + lm.getSequenceNumber());
            ...
            date = lm.getSubmissionTime();
            int seq = lm.getSequenceNumber();
