...
/**
 * Test program that connects to either a P7 Message Store, fetches all the
 * messages (without showing them or doing anything with them) and then deletes
 * them.
 *
 */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 1; i < list_array.size(); i++) {
                ...
                d = rm.getMessageDeliveryTimeAsDate();
                diffTime = d.getTime() - now.getTime() ;
