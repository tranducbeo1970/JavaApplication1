        ...
        try {
            ...
            if (extended) {
               ...
               atsMessage.setStringparam(AMHS_att.ATS_S_PRIORITY_INDICATOR, "FF");
                ...
                atsMessage.setStringparam(AMHS_att.ATS_S_TEXT, "AAAAAAAAAAAAAAAAAAAAAAA");
          ...
          //  int result = X400ms.x400_ms_msgmakeIPN(atsMessage, 0, ipnMessage);
    
          //  X400Msg atsMessage1  =  (X400Msg)ipnMessage;
            // Send the message to the Message Store
            //atsMessage.sendMsg(bind_session);
            int code = com.isode.x400api.X400ms.x400_ms_msgsend(atsMessage);
