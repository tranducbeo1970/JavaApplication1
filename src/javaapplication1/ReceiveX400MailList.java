 ...
 *
 */
public class ReceiveX400MailList {
    ...
    private static boolean only_show_mailbox_summary = true;
...
//                        }
    ...
    public static void showMessage(ReceiveMsg rm) throws X400APIException {
        ...
        if (status == X400_att.X400_E_NOERROR) {
            ...
            int ii = rm.getIntParam(AMHS_att.ATS_N_EXTENDED);
...
*************************************************/        
        ...
        System.out.println("List mailbox co " + Integer.toString(list_array.size()));
        ...
        for (int i = 1; i < list_array.size(); i++) {
            ...
            seq = lm.getSequenceNumber();
            System.out.println("The getSequenceNumber is " +  Integer.toString(seq));
        }
        try {
            Thread.sleep(5000);
        } catch (InterruptedException ex) {
            Logger.getLogger(ReceiveX400MailList.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
