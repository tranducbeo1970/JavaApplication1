...
#
# javac -sourcepath . -verbose -classpath ".:/opt/isode/lib/java/classes/isode-x400.jar:/opt/isode/lib/java/classes/isode-x400mt.jar:/opt/isode/share/x400sdk/example/java/" \
#	-g X400_mttest.java
#
#
...
LD_LIBRARY_PATH=/opt/isode/lib:$LD_LIBRARY_PATH java -classpath .:/opt/isode/lib/java/classes/isode-x400mt.jar -Xms20m X400_mttest
