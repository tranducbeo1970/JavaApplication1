...
package javaapplication1.java.com.isode.x400.highlevel.test;
...
public class SendX400MailP3 {
	...
	private static String p3_channel_presentation_address = "\"593\"/Internet=10.64.1.102+102";
	private static String p3_user_or_address = "/CN=VVVVZPZX/OU=VVVV/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
	private static String p3_user_password = "amhs";
	private static boolean submit_only = true;

	private static String recipient_or_address =  "/CN=VVTSOPTB/OU=VVTS/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";;
	...
	public static void main(String[] args) {
		...
		try {
			...
			// If you don't want positive DRs, use DR_NON_DELIVERY_REPORT or DR_NO_REPORT
                        String aftn = "/CN=VVTSXXXX/OU=VVTS/O=VVTS/PRMD=VIETNAM/ADMD=ICAO/C=XX/";
			...
			BodypartIA5Text ia5 = new BodypartIA5Text("TESTING SEND BY P3 VVVVZPZX");
