 ...
 *
 */
public class ReceiveX400Mail2026 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(ReceiveX400Mail2026.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                else {
                ...
                int num_of_msgs=0;
                try {
                    num_of_msgs = connection.getRefreshNumberOfMessages();
                } catch (X400APIException ex) {
                    Logger.getLogger(ReceiveX400Mail2026.class.getName()).log(Level.SEVERE, null, ex);
                }

                System.out.println("\nThere are " + Integer.toString(num_of_msgs));
                while(true) {
                        System.out.println("\nShowing message number ");
                       
                        ReceiveMsg rm = null;
                    try {
                        rm = connection.receiveNextAvailableMessage();
                    } catch (X400APIException ex) {
                        Logger.getLogger(ReceiveX400Mail2026.class.getName()).log(Level.SEVERE, null, ex);
                    }
                        if(rm == null) {
